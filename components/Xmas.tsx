  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (container && container.children.length === 0) {
        console.log('Initializing Xmas page...')
      }
    }, 100)
    ...
    <div style={{ width: '100%', height: '100vh', overflow: 'hidden' }}>
      ...
      <style>{`
        ...
        @keyframes snowfall {
          ...
          100% {
            transform: translateY(200vh) translateX(100px) rotate(360deg);
            opacity: 0;
          }
        }

        @keyframes snowfall-swing {
          0%, 100% {
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        const photoFiles = ['./img/1.jpg','./img/2.jpg','./img/3.jpg','./img/4.jpg','./img/5.jpg'];
        const photoTextures = [];
        ...
        function createDecorations() {
          ...
          titleMesh = new THREE.Mesh(new THREE.PlaneGeometry(60, 35), mat);
        ...
        function startSystem() {
          ...
          hands.onResults(results => {
            ...
            if (results.multiHandLandmarks.length > 0) {
              ...
              state = 'TREE';
              statusDiv.innerText = "🎄 Giáng Sinh An Lành 🎄";
        ...
        function createSnowflake() {
          ...
          snowflake.innerHTML = '❄';
          snowflake.className = 'snowflake snowfall-animation';
        ...
        // Create snowflakes every 100ms (more frequent)
